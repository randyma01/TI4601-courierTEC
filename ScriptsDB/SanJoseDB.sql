...
('Sede Central Heredia', 24859632, 'che@couriertec.com');
GO
...
(GETDATE(), 'Ropa', 'Tennis corredor', 2, 35000, 45000, 'Camino'),
(GETDATE(), 'Juegos', 'Juego de mesa', 1, 15000, 20000, 'Sucursal'),
(GETDATE(), 'Ropa', 'Jeans', 4, 30000, 80000, 'Sucursal'),
(GETDATE(), 'Ropa', 'Jeans', 4, 30000, 80000, 'Retirado'),
(GETDATE(), 'Electronico', 'Pantalla', 20, 1000000, 30000, 'Retirado');
GO
...
INSERT INTO Cliente_Paquete (IdCliente) VALUES
(1), (2), (3), (4);
GO

-- Llenado tabla de los Paquetes por Sucursal --
INSERT INTO Paquete_Sucursal (IdSucursal) VALUES
(1), (2), (3), (4);
GO
